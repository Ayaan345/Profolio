...
//       )}
//       {/* Hero Section */}
//       <section id="hero" ref={heroRef} className="flex flex-col md:flex-row items-center justify-between px-8 py-16 relative h-screen font-[family-name:var(--font-montserrat)]">
//         <Blackhole />
//         <div className="md:w-1/2 space-y-4 z-20 ml-10 mb-32">


//           <h1 className="text-2xl">I’m</h1>
//           <h2 className="text-6xl font-bold">Ayaan</h2>
//           <p className="text-gray-300 max-w-lg">
//             A MERN stack developer focused on solving real-world
//             problems by building interactive 3D web experiences and
//             real-time platforms. I turn ideas into scalable solutions
//             that help students, businesses, and communities.
//           </p>
...
//       {/* Projects Section */}
//       <section id="projects" ref={projectsRef} className="px-8 py-16 h-fit">
//         <div className="flex flex-col items-center align-middle mb-20 " >
...
//             <div className={`bg-[#38394a] p-6 rounded-xl w-full lg:w-1/2 transition-all duration-1000 ease-out ${classCastImageVisible
...
//                     className="rounded-xl w-full h-85 object-cover cursor-pointer hover:opacity-90 transition-opacity"
...
//                 <h3 className="text-4xl mb-2">ClassCast</h3>
//               </div>
//               {/* <p className="text-gray-300 mb-4 min-h-[6rem]">
//                 {classCastTyping.displayedText}
//                 {classCastTyping.isTyping && <span className="animate-pulse">|</span>}
//               </p> */}
//               <div className="">
//                 <span>
//                   <div className="flex text-gray-300 ">
//                     <p className="text-xl font-bold">Problem:</p> <p className="mb-2 ml-2">Students struggle to take notes and collaborate effectively during online lectures.</p>
//                   </div>
//                   <div className="flex text-gray-300  ">
//                     <p className="text-xl font-bold">Solution:</p> <p className="mb-2 ml-2">I built ClassCast, a real-time note-taking platform where students can add timeline-based notes
//                       to videos, share them with classmates, and revisit lectures more effectively.</p>
//                   </div>
//                   <div className="flex text-gray-300  ">
//                     <p className="text-xl font-bold">Impact:</p> <p className="mb-2 ml-2">Improved study collaboration and reduced missed information during online learning sessions.</p>
//                   </div>
...
//             <div className={`bg-[#38394a] p-6 rounded-xl w-full lg:w-1/2 transition-all duration-1000 ease-out ${snapShoprImageVisible
//               ? 'transform translate-y-0 opacity-100'
//               : 'transform translate-y-20 opacity-0'
//               }`}>
//               <Swiper
...
//               <div className="flex justify-center">
//                 <h3 className="text-4xl mb-2">SnapShopr</h3>
//               </div>
//               {/* <p className="text-gray-300 mb-4 min-h-[6rem]">
//                 {snapShoprTyping.displayedText}
//                 {snapShoprTyping.isTyping && <span className="animate-pulse">|</span>}
//               </p> */}
//               <div className="">
//                 <span>
//                   <div className="flex text-gray-300 ">
//                     <p className="text-xl font-bold">Problem:</p> <p className="mb-2 ml-2">College people often waste time searching multiple websites to find affordable products.</p>
//                   </div>
//                   <div className="flex text-gray-300  ">
//                     <p className="text-xl font-bold">Solution:</p> <p className="mb-2 ml-2">SnapShopr is a hyper-local marketplace where students can buy/sell items quickly, with
//                       real-time chat built in for smooth transactions.</p>
//                   </div>
//                   <div className="flex text-gray-300  ">
//                     <p className="text-xl font-bold">Impact:</p> <p className="mb-2 ml-2">Helped people save money and time by simplifying campus trading into one seamless platform.</p>
//                   </div>
...
//       {/* Skills Section */}
//       <section id="skills" ref={skillsRef} className="px-8 py-16  h-fit">
//         <div className="flex flex-col items-center">
//           <h2 className="text-5xl mb-3">Skills</h2>
//           <p className="text-gray-300  max-w-2xl mb-20">
...
//             <div className={`bg-[#2e2e2e] rounded-xl p-6 mr-10 w-[60%] transition-all duration-800 ease-out ${languagesVisible
...
//                   <img src="/icons/js.png" alt="JavaScript" className="w-27 h-31 pt-5" />

//                 </div>
//                 <div className="flex items-center gap-2 rounded-full px-4 py-2">
//                   <img src="/icons/css.svg" alt="CSS" className="w-30 h-30" />

//                 </div>
//                 <div className="flex items-center gap-2 rounded-full px-4 py-2">
//                   <img src="/icons/html.svg" alt="HTML" className="w-30 h-30" />
...
//             {/* Tools & Platforms */}
//             <div className={`bg-[#2e2e2e] rounded-xl p-6 w-[35%] transition-all duration-800 ease-out ${toolsVisible
//               ? 'transform translate-x-0 opacity-100'
//               : 'transform translate-x-20 opacity-0'
//               }`}>
//               <div className="flex justify-center">
//                 <h2 className="text-3xl mb-8">Tools & Platform</h2>
//               </div>
//               <div className="flex flex-wrap justify-center gap-4">
//                 <div className="flex items-center gap-2  rounded-full px-4 py-2">
//                   <img src="/icons/github.svg" alt="GitHub" className="w-25 h-25" />

//                 </div>
//                 <div className="flex items-center gap-2 rounded-full px-4 py-2">
//                   <img src="/icons/vercel.png" alt="Vercel" className="w-45 h-10" />
...
//             <div className={`bg-[#2e2e2e] rounded-xl p-6 mr-10 ml-4 w-[75%] transition-all duration-800 ease-out ${frameworksVisible
//               ? 'transform translate-x-0 opacity-100'
//               : 'transform -translate-x-20 opacity-0'
//               }`}>
//               <div className="flex justify-center">
//                 <h2 className="text-3xl mb-2">Frameworks</h2>
//               </div>
//               <div className="flex flex-wrap justify-center gap-4 ">
//                 <div className="flex items-center gap-2 rounded-full px-4 ">
//                   <img src="/icons/react.svg" alt="React" className="w-30 h-30" />

//                 </div>
//                 <div className="flex items-center gap-2  rounded-full px-4">
//                   <img src="/icons/express.png" alt="Express" className="w-30 h-30" />

//                 </div>
//                 <div className="flex items-center gap-2 rounded-full px-4 \">
//                   <img src="/icons/next.svg" alt="Next.js" className="w-50 h-40 text-white" />

//                 </div>
//                 <div className="flex items-center  gap-2 rounded-full px-4 \">
//                   <img src="/icons/mongo.svg" alt="MongoDB" className="w-50 h-40" />

//                 </div>
//               </div>
//             </div>
//             {/* Design */}
//             <div className={`bg-[#2e2e2e] rounded-xl mr-4 p-6 w-[25%] transition-all duration-800 ease-out ${designVisible
//               ? 'transform translate-x-0 opacity-100'
//               : 'transform translate-x-20 opacity-0'
//               }`}>
//               <div className="flex justify-center">
//                 <h2 className="text-3xl mb-8">Design</h2>
//               </div>
//               <div className="flex flex-wrap gap-4 justify-center">
//                 <div className="flex items-center gap-2  rounded-full px-4 py-2">
//                   <img src="/icons/figma.svg" alt="Figma" className="w-25 h-25" />
...
//           {/* Text in front of the moon cutout */}
//           <div className="relative z-10 text-center">
//             <h2 className="text-white text-8xl font-semibold tracking-wider mb-40">
//               Connect With Me
//             </h2>
//           </div>

//           {/* Moon cutout image, positioned on top of the text */}
...
//             {/* Social media icons, positioned over the moon */}
//             <div className="absolute inset-0 flex flex-col items-center justify-end pb-24 space-y-4">

//               {/* Wrapper for Gmail icon and its animated text */}
//               {/* Use flex-row to align items horizontally */}
//               <div className="relative flex items-center">
//                 <button
//                   onClick={handleGmailClick}
//                   className={`relative z-10 transition-transform duration-500 ease-in-out ${showEmail ? 'transform -translate-x-28' : 'transform translate-x-0'}`}
//                 >
//                   <img
//                     src="./gmail.svg"
//                     alt="Gmail"
...
//                 {/* The email text that slides in from the left */}
//                 <div
...
//                   style={{
//                     width: showEmail ? '15rem' : '0', // Adjust width as needed
//                     opacity: showEmail ? '1' : '0',
//                     transform: showEmail ? 'translateX(10px)' : 'translateX(0)' // Moves to the right
//                   }}
//                 >
//                   <p className="whitespace-nowrap text-lg">example1234265@gmail.com</p>
//                 </div>
//               </div>
//               <div className="relative flex items-center">
//                 <button
//                   onClick={handleLinkClick}
//                   className={`relative z-10 transition-transform duration-500 ease-in-out ${showLink ? 'transform -translate-x-28' : 'transform translate-x-0'}`}
//                 >
//                   <img
//                     src="./link.svg"
//                     alt="LinkedIn"
...
//                   />
//                 </button>
//                 {/* The LinkedIn text that slides in from the left */}
//                 <div
//                   className={`absolute left-full transform -translate-x-1/2 text-white transition-all duration-500 ease-in-out overflow-hidden`}
//                   style={{
//                     width: showLink ? '15rem' : '0', // Adjust width as needed
//                     opacity: showLink ? '1' : '0',
//                     transform: showLink ? 'translateX(10px)' : 'translateX(0)' // Moves to the right
//                   }}
//                 >
//                   <p className="whitespace-nowrap text-lg">Ayaan Shoaib</p>
//                 </div>
//               </div>
//             </div>
//           </div>
